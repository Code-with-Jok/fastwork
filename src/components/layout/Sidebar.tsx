...
const menuItems = [
  ...
  },
  {
    key: "finance",
    icon: <DollarOutlined />,
    label: "Theo dõi tài chính",
    href: "/insight/finance",
  },
  {
    key: "contract",
    icon: <FileTextOutlined />,
    label: "Theo dõi HĐ nhận thầu",
    href: "/insight/contract",
  },
  {
    key: "material",
    icon: <DropboxOutlined />,
    label: "Cung ứng vật tư",
    href: "/insight/material",
  },
  {
    key: "progress",
